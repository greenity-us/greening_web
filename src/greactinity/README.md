Greenity Webapp bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).

To run the following project, make sure you have [Node](https://nodejs.org/en/) installed. Then run `npm install -g yarn` to install Yarn.

Then run `yarn start` to open a local server running the project, along with some instructions for other commands you can run.
